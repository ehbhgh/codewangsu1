$(function(){
    ...
    $(".previewPic>img").mouseover(function(){
        ...
        console.log('../images/yifu'+$obj+'big.jpg');
     
        $("#showPic").attr('src','../images/yifu'+$obj+'big.jpg');
        $("#showBigpic").attr('src','../images/yifu'+$obj+'big.jpg');
        $(".clothSort>img").attr('src','../images/yifu'+$obj+'.webp');
    ...
    $(".buyRight").click(function(){
        ...
        if(count>=1){
            $(".alerts").css("display","block");
            $(".container").text("请您支付"+(($result+1)*668)+"元！")
            $(".shadow").css("display","block"); 
        }else{
            $(".alerts").css("display","block");
