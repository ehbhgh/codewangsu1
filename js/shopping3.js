$(function(){
    ...
    $(".previewPic>img").mouseover(function(){
        ...
        console.log('../images/phoone'+$obj+'.jpg');
     
        $("#showPic").attr('src','../images/phoone'+$obj+'.jpg');
        $("#showBigpic").attr('src','../images/phoone'+$obj+'.jpg');
        $(".clothSort>img").attr('src','../images/phoone'+$obj+'.webp');
    ...
    $(".buyRight").click(function(){
        ...
        if(count>=1){
            $(".alerts").css("display","block");
            $(".container").text("请您支付"+(($result+1)*1416)+"元！")
            $(".shadow").css("display","block"); 
        }else{
            $(".alerts").css("display","block");
            $(".container").text("请选择机身颜色")
            $(".shadow").css("display","block"); 
        }
